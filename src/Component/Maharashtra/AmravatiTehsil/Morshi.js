...
<Link to="/sector"><span><AiOutlineArrowLeft /></span></Link>
    ...
    <div className='tehsil-sub-text'>
        <h1>total budget</h1>
        <h4>$ 20,00,000</h4>
        <p>Morshi is the second largest town in the Amravati district of Maharashtra, India. It is located 55 km north-east of Amravati, situated very close to the border with Madhya Pradesh, in the scenic southern foothills of the Satpura ranges.</p>
        </div>
    </div>
