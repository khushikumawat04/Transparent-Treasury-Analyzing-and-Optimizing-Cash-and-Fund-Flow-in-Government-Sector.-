...
<Link to="/sector"><span><AiOutlineArrowLeft /></span></Link>
    ...
    <div className='tehsil-sub-text'>
        <h1>total budget</h1>
        <h4>$ 20,00,000</h4>
        <p>Daryapur is a city located in the Amravati District of Maharashtra State, India. It belongs to the Vidarbha region of the Amravati Division. It is located 52 km west of the District headquarters of Amravati.</p>
        </div>
    </div>
