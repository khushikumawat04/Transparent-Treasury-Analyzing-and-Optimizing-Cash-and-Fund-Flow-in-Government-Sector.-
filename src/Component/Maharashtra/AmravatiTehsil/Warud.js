...
const Warud = () => {
  ...
  const getvillagedata = SectorData.find((state) => state.state_id === "2")
        ...
        .tehsil.find((tehsil) => tehsil.tehsil_id === "14").villages;
...
<Link to="/sector"><span><AiOutlineArrowLeft /></span></Link>
    ...
    <div className='tehsil-sub-text'>
        <h1>total budget</h1>
        <h4>$ 20,00,000</h4>
        <p>Warud is a Taluka located in Amravati district of Maharashtra. It is one of 14 Talukas of Amravati district. There are 139 villages and 2 towns in Warud Taluka.

As per the Census India 2011, Warud Taluka has 51927 households, population of 224984 of which 115687 are males and 109297 are females. The population of children between age 0-6 is 22898 which is 10.18% of total population.    </p>
</div>
    </div>
