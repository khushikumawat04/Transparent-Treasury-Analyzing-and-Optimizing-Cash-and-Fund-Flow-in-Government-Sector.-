...
const NandgaonKhandeshwar = () => {
  ...
  const getvillagedata = SectorData.find((state) => state.state_id === "2")
        ...
        .tehsil.find((tehsil) => tehsil.tehsil_id === "12").villages;
...
<Link to="/sector"><span><AiOutlineArrowLeft /></span></Link>
    ...
    <div className='tehsil-sub-text'>
        <h1>total budget</h1>
        <h4>$ 20,00,000</h4>
        <p>Nandgaon Khandeshwar is a city and a municipal council in Amravati district in the state of Maharashtra, India. Nandgaon Khandeshwar is one of the three townships in Chandur subdivision in Amravati district. The other two are Dhamangaon Railway and Chandur Railway.</p>
        </div>
    </div>
    ...
    <div className="tehsil-table">
        <div className="button">
           ...
           <button><CSVLink
      data={userdata}
      filename="NandgaonKhandeshwarvillage"
      style={{color:"white"}}
...
export default NandgaonKhandeshwar;