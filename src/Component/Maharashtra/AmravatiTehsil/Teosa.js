...
<Link to="/sector"><span><AiOutlineArrowLeft /></span></Link>
    ...
    <div className='tehsil-sub-text'>
        <h1>total budget</h1>
        <h4>$ 20,00,000</h4>
        <p>Tiosa, or Tivsa, is a town, municipal council, and tehsil in Amravati district in the state of Maharashtra, India. </p>
        </div>
    </div>
