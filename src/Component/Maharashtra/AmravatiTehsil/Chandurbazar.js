...
const Chandurbazar= () => {
  ...
  const getvillagedata = SectorData.find((state) => state.state_id === "2")
        ...
        .tehsil.find((tehsil) => tehsil.tehsil_id === "6").villages;
...
<Link to="/sector"><span><AiOutlineArrowLeft /></span></Link>
    ...
    <div className='tehsil-sub-text'>
        <h1>total budget</h1>
        <h4>$ 20,00,000</h4>
        <p>Chandurbazar is a Municipal Council city in district of Amravati, Maharashtra. The Chandurbazar city is divided into 17 wards for which elections are held every 5 years. The Chandurbazar Municipal Council has population of 18,759 of which 9,529 are males while 9,230 are females as per report released by Census India 2011.</p>
        </div>
    </div>
