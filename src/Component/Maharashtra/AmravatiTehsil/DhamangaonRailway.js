...
<Link to="/sector"><span><AiOutlineArrowLeft /></span></Link>
    ...
    <div className='tehsil-sub-text'>
        <h1>total budget</h1>
        <h4>$ 20,00,000</h4>
        <p>Dhamangaon is a city and a municipal council in Amravati district in the state of Maharashtra, India. Dhamangaon is one of the three talukas in Chandur subdivision in Amravati district. The municipal council is named as Dattapur-Dhamangaon Municipal council.</p>
        </div>
    </div>
    ...
    <div className="tehsil-table">
        <div className="button">
           ...
           <button><CSVLink
      data={userdata}
      filename="DhamangaonRailwayvillage"
      style={{color:"white"}}
...
export default DhamangaonRailway;