...
<Link to="/sector"><span><AiOutlineArrowLeft /></span></Link>
    ...
    <div className='tehsil-sub-text'>
        <h1>total budget</h1>
        <h4>$ 20,00,000</h4>
        <p> Karjat is a town in Ahmednagar district in Indian state of Maharashtra.[1] It is located 75 km from its District city of Ahmednagar. Rehekuri Sanctuary; a world-famous habitat for deer and there is a habitat for the Great Indian Bustard nearby.

Karjat city is socially developed and is the centre of educational institute in this central western region of Maharashtra state</p>
</div>
    </div>
