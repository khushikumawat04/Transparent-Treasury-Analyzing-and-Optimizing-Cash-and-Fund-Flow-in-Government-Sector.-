...
<Link to="/sector"><span><AiOutlineArrowLeft /></span></Link>
    ...
    <div className='tehsil-sub-text'>
        <h1>total budget</h1>
        <h4>$ 20,00,000</h4>
        <p> Sangamner is located at 19.57°N 74.22°E,[1] on the banks of the Pravara River. It has an average elevation of 549 metres (1,801 ft)from mean sea level. Sangamner is the biggest settlement on NH 50 (New NH-60) between Pune (143 km distance) and Nashik (69 km distance). It is about 230 km from financial capital of India, Mumbai. On 15 August 2014, newly constructed by-pass was opened for traffic (9.5 km) which saves about 30.0 min of commute time. </p>
        </div>
    </div>
