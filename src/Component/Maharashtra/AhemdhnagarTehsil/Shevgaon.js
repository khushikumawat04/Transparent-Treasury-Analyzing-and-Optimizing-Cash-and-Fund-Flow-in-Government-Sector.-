...
<Link to="/sector"><span><AiOutlineArrowLeft /></span></Link>
    ...
    <div className='tehsil-sub-text'>
        <h1>total budget</h1>
        <h4>$ 20,00,000</h4>
        <p> Shevgaon is a Town in Shevgaon Taluka in Ahmednagar District of Maharashtra State, India. It belongs to Khandesh and Northern Maharashtra region . It belongs to Nashik Division . It is located 67 KM towards East from District head quarters Ahmednagar. It is a Taluka head quarter..</p>
        </div>
    </div>
