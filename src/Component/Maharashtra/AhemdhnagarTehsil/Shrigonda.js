...
<Link to="/sector"><span><AiOutlineArrowLeft /></span></Link>
    ...
    <div className='tehsil-sub-text'>
        <h1>total budget</h1>
        <h4>$ 20,00,000</h4>
        <p> Total area of shrigonda tehsil is 1,603 km² including 1,517.17 km² rural area and 85.65 km² urban area. Shrigonda tehsil has a population of 3,15,975 peoples, out of which urban population is 31,134 while rural population is 2,84,841. Shrigonda tehsil has a population density of 197.1 inhabitants per square kilometre.</p>
        </div>
    </div>
