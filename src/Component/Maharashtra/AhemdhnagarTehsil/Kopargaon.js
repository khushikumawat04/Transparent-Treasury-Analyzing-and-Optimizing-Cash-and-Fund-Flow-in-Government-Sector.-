...
<Link to="/sector"><span><AiOutlineArrowLeft /></span></Link>
    ...
    <div className='tehsil-sub-text'>
        <h1>total budget</h1>
        <h4>$ 20,00,000</h4>
        <p> Total area of kopargaon tehsil is 735 km² including 724.88 km² rural area and 10.53 km² urban area. Kopargaon tehsil has a population of 3,02,452 peoples, out of which urban population is 65,273 while rural population is 2,37,179. Kopargaon tehsil has a population density of 411.3 inhabitants per square kilometre.</p>
        </div>
    </div>
