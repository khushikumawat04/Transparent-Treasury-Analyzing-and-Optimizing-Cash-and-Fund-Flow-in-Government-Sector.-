...
<Link to="/sector"><span><AiOutlineArrowLeft /></span></Link>
    ...
    <div className='tehsil-sub-text'>
        <h1>total budget</h1>
        <h4>$ 20,00,000</h4>
        <p>Nevasa is a city in Nevasa tehsil of Ahmednagar district in the Indian state of Maharashtra. Old name of this place are Nidhinivas, Nivas and Mahalaya Also town of lord Kuber. Sant Dnyaneshwar Temple is main temple. This place is near of Pravara river this river also called Amritvahini.
