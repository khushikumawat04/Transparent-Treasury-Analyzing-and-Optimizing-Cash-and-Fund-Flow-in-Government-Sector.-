...
const Akole = () => {
  ...
  const getvillagedata = SectorData.find((state) => state.state_id === "2")
        ...
        .tehsil.find((tehsil) => tehsil.tehsil_id === "10").villages;
...
<Link to="/sector"><span><AiOutlineArrowLeft /></span></Link>
    ...
    <div className='tehsil-sub-text'>
        <h1>total budget</h1>
        <h4>$ 20,00,000</h4>
        <p> Akole is a city and Taluka in Akole tehsil, Ahmednagar district in the state of Maharashtra, India. Akole is surrounded by the Sahyadri Mountains of Western Ghats, India. Several historical sites in the city honor Akole's connection to the history and culture of Maharashtra.[1] </p>
        </div>
    </div>
