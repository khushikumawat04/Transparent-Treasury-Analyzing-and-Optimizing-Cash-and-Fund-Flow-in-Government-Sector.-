...
<Link to="/sector"><span><AiOutlineArrowLeft /></span></Link>
    ...
    <div className='tehsil-sub-text'>
        <h1>total budget</h1>
        <h4>$ 20,00,000</h4>
        <p>Jamkhed is a census town in Ahmednagar district in the Indian state of Maharashtra. Jamkhed is in between the Ahmednagar and Beed. Jamkhed is very well known for its comprehensive rural health project CRHP. It also has Jamkhed homeopathic college, nursing college. </p>
        </div>
