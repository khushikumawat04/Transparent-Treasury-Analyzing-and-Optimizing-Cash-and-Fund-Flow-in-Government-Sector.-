...
const Rahata = () => {
  ...
  const getvillagedata = SectorData.find((state) => state.state_id === "2")
        ...
        .tehsil.find((tehsil) => tehsil.tehsil_id === "11").villages;
...
<Link to="/sector"><span><AiOutlineArrowLeft /></span></Link>
    ...
    <div className='tehsil-sub-text'>
        <h1>total budget</h1>
        <h4>$ 20,00,000</h4>
        <p> Total area of rahta tehsil is 650 km² including 614.41 km² rural area and 35.31 km² urban area. Rahta tehsil has a population of 3,20,485 peoples, out of which urban population is 58,339 while rural population is 2,62,146. Rahta tehsil has a population density of 493.3 inhabitants per square kilometre.</p>
        </div>
    </div>
