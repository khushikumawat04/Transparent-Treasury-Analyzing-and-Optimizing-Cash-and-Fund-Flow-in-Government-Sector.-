...
<Link to="/sector"><span><AiOutlineArrowLeft /></span></Link>
    ...
    <div className='tehsil-sub-text'>
        <h1>total budget</h1>
        <h4>$ 20,00,000</h4>
        <p> Total area of Rahuri tehsil is 552 km² including 542.60 km² rural area and 9.02 km² urban area. Rahuri tehsil has a population of 2,87,500 peoples, out of which urban population is 89,282 while rural population is 1,98,218. Rahuri tehsil has a population density of 521.2 inhabitants per square kilometre.</p>
        </div>
    </div>
