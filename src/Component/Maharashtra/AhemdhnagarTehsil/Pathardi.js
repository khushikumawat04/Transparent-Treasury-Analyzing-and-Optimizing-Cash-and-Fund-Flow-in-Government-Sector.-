...
<Link to="/sector"><span><AiOutlineArrowLeft /></span></Link>
    ...
    <div className='tehsil-sub-text'>
        <h1>total budget</h1>
        <h4>$ 20,00,000</h4>
        <p>Pathardi taluka, is a taluka in Ahmednagar subdivision of Ahmednagar district in Maharashtra State of India</p>
        </div>
    </div>
