...
<Link to="/sector"><span><AiOutlineArrowLeft /></span></Link>
    ...
    <div className='tehsil-sub-text'>
        <h1>total budget</h1>
        <h4>$ 20,00,000</h4>
        <p>Ahmednagar, is a city in the Ahmednagar district, Maharashtra, India, about 120 km northeast of Pune and 114 km from Aurangabad. It is the seat of its namesake district. The city has been renamed as 'Ahilya Nagar' by the Government of Maharashtra as a tribute to Brave Maratha Queen Ahilya Bai Holkar.</p>
        <div className="about-link">
              <strong>Visit For More Detail - </strong>
              <Link to="https://ahmednagar.nic.in/">https://ahmednagar.nic.in/</Link>
            </div>
        </div>
    </div>
    ...
    <div className="cbox">
        ...
        <div className="small">
            <div className="sc-box">
              <h4>Area <br/>  <span>17,048 Sq.Km.</span></h4>
            </div>
            <div className="sc-box">
              <h4>Population <br/>  <span>418,000</span></h4>
            </div>
            <div className="sc-box">
              <h4>Language <br/>  <span>Hindi <br/>Marathi </span></h4>
            </div>
            <div className="sc-box">
              <h4>Villages <br/>  <span>106</span></h4>
            </div>
        </div>
    ...
    <div className="table-mini-box">
        ...
        <div className="box box-2">Village Name</div>
