...
<Link to="/sector"><span><AiOutlineArrowLeft /></span></Link>
    ...
    <div className='tehsil-sub-text'>
        <h1>total budget</h1>
        <h4>$ 20,00,000</h4>
        <p>Akola district (Marathi pronunciation: [əkolaː]) is a district in the Indian state of Maharashtra. The city of Akola is the district headquarters. Akola district forms the central part of Amravati Division, which was the former British Raj Berar Province.
...
<div className="about-link">
              ...
              <Link to="https://akola.gov.in/">https://akola.gov.in/</Link>
            </div>
</div>
    </div>
    ...
    <div className="cbox">
        ...
        <div className="small">
            <div className="sc-box">
              <h4>Area <br/>  <span>124 Sq.Km.</span></h4>
            </div>
            <div className="sc-box">
              <h4>Population <br/>  <span>466,000</span></h4>
            </div>
            <div className="sc-box">
              <h4>Language <br/>  <span>Hindi <br/>Marathi </span></h4>
            </div>
            <div className="sc-box">
              <h4>Villages <br/>  <span>174</span></h4>
            </div>
        </div>
