...
<Link to="/sector"><span><AiOutlineArrowLeft /></span></Link>
    ...
    <div className='tehsil-sub-text'>
        <h1>total budget</h1>
        <h4>$ 20,00,000</h4>
        <p>Beed district (Marathi pronunciation is an administrative district in the state of Maharashtra in India. The district headquarters are located at Beed. The district occupies an area of 10,693 km² and has a population of 2,585,049 of which 17.91% were urban (as of 2011).</p>
        <div className="about-link">
              <strong>Visit For More Detail - </strong>
              <Link to="https://beed.gov.in/">https://beed.gov.in/</Link>
            </div>
        </div>
    </div>
    ...
    <div className="cbox">
        ...
        <div className="small">
            <div className="sc-box">
              <h4>Area <br/>  <span>10,693 Sq.Km.</span></h4>
            </div>
            <div className="sc-box">
              <h4>Population <br/>  <span>2,585,049</span></h4>
            </div>
            <div className="sc-box">
              <h4>Language <br/>  <span>Marathi</span></h4>
            </div>
            <div className="sc-box">
              <h4>Villages <br/>  <span>224</span></h4>
            </div>
        </div>
