    ...
    <div className="cbox">
        ...
        <div className="small">
            <div className="sc-box">
              <h4>Area <br/>  <span>183.5 Sq.Km.</span></h4>
            </div>
            <div className="sc-box">
              <h4>Population <br/>  <span>793,000</span></h4>
            </div>
            <div className="sc-box">
              <h4>Language <br/>  <span>  Marathi</span></h4>
            </div>
            <div className="sc-box">
              <h4>Villages <br/>  <span>130</span></h4>
            </div>
        </div>
