...
<Link to="/sector"><span><AiOutlineArrowLeft /></span></Link>
    ...
    <div className='tehsil-sub-text'>
        <h1>total budget</h1>
        <h4>$ 20,00,000</h4>
        <p> Murtijapur is a Municipal council and one of the taluka of district of Akola of Amravati division of Vidarbha region of Maharashtra.Murtijapur is located at an average elevation of 308 metres (1210 feet).[2] It is an important railway junction station in Akola district and is under Bhusawal-Badnera Section of Bhusawal Division of Central Railway.</p>
        </div>
    </div>
