...
<Link to="/sector"><span><AiOutlineArrowLeft /></span></Link>
    ...
    <div className='tehsil-sub-text'>
        <h1>total budget</h1>
        <h4>$ 20,00,000</h4>
        <p>Telhara is a town and a municipal council in Akola district in the Indian state of Maharashtra. Telhara is called the Cotton City; it is one of the largest cotton-producing subdistrict in Vidarbha Region. It is located 54 km towards North from District headquarters Akola. It is a Taluka headquarter.
...
Akola, Amravati, Khamgaon, Akot are the nearby cities to Telhara. The town is also known for the vibrant Varhadi language.</p>
</div>
    </div>
