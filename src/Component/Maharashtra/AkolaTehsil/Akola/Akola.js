...
<Link to="/sector"><span><AiOutlineArrowLeft /></span></Link>
    ...
    <div className='tehsil-sub-text'>
        <h1>total budget</h1>
        <h4>$ 20,00,000</h4>
        <p> Akola district is a district in the Indian state of Maharashtra. The city of Akola is the district headquarters. Akola district forms the central part of Amravati Division, which was the former British Raj Berar Province.
