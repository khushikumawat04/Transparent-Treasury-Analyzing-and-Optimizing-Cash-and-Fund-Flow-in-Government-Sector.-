...
<Link to="/sector"><span><AiOutlineArrowLeft /></span></Link>
    ...
    <div className='tehsil-sub-text'>
        <h1>total budget</h1>
        <h4>$ 20,00,000</h4>
        <p>Jhiranya is a small Village/hamlet in Maheshwar Tehsil in Khargone District of Madhya Pradesh State, India. It comes under Jhirnaya Panchayath. It belongs to Indore Division . It is located 56 KM towards North from District head quarters Khargone. 245 KM from State capital Bhopal Jhiranya is surrounded by Kasrawad Tehsil towards South , Dharampuri Tehsil towards west , Mhow Tehsil towards North , Barwah Tehsil towards East. Mhow Cantonment , Mhowgaon , Sanawad , Pithampur are the near by Cities to Jhiranya.
        </p>
        </div>
    </div>
