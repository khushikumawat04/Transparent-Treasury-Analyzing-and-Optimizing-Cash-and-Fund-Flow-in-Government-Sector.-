...
const Segaon = () => {
  ...
  const getvillagedata = SectorData.find((state) => state.state_id === "1")
        .District.find((district) => district.District_id === "1")
        .tehsil.find((tehsil) => tehsil.tehsil_id === "9").villages;
...
<Link to="/sector"><span><AiOutlineArrowLeft /></span></Link>
    ...
    <div className='tehsil-sub-text'>
        <h1>total budget</h1>
        <h4>$ 20,00,000</h4>
        <p>Segaon is a Town in Segaon Tehsil in Khargone District of Madhya Pradesh State, India. It belongs to Indore Division . It is located 31 KM towards west from District head quarters Khargone. It is a Tehsil head quarter. Segaon Pin code is 451442 and postal head office is Segaon (West Nimar). Gatlakhedi ( 4 KM ) , Domwada ( 5 KM ) , Rasgaon ( 6 KM ) , Birla ( 6 KM ) , Dasnawal ( 6 KM ) are the nearby Villages to Segaon. Segaon is surrounded by Rajpur Tehsil towards west , Ziranya Tehsil towards East , Thikri Tehsil towards North , Khargone Tehsil towards East. Sendhwa , Manawar , Barwani , Shirpur-Warwade are the nearby Cities to Segaon.
        </p>
        </div>
    </div>
