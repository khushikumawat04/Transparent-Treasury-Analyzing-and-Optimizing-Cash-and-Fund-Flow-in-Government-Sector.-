...
<Link to="/sector"><span><AiOutlineArrowLeft /></span></Link>
    ...
    <div className='tehsil-sub-text'>
        <h1>total budget</h1>
        <h4>$ 20,00,000</h4>
        <p>Bhagwanpura is a Town in Bhagvanpura Tehsil in Khargone District of Madhya Pradesh State, India. It belongs to Indore Division . It is located 21 KM towards South from District head quarters Khargone. It is a Tehsil head quarter. Bhagwanpura Pin code is 451441 and postal head office is Bistan. Bhagwanpura is surrounded by Gogawan Tehsil towards North , Khargone Tehsil towards North , Ziranya Tehsil towards North , Segaon Tehsil towards west. Yawal , Sendhwa , Raver , Sanawad are the nearby Cities to Bhagwanpura.
        </p>
        </div>
    </div>
