...
<Link to="/sector"><span><AiOutlineArrowLeft /></span></Link>
    ...
    <div className='tehsil-sub-text'>
        <h1>total budget</h1>
        <h4>$ 20,00,000</h4>
        <p>Kasrawad is a small Village/hamlet in Kasrawad Tehsil in Khargone District of Madhya Pradesh State, India. It comes under Kasrawad Panchayath. It belongs to Indore Division . It is located 38 KM towards North from District head quarters Khargone. 7 KM from Chhoti Kasrawad. 262 KM from State capital Bhopal Kasrawad Pin code is 451228 and postal head office is Kasrawad.
        </p>
        </div>
    </div>
