...
<Link to="/sector"><span><AiOutlineArrowLeft /></span></Link>
    ...
    <div className='tehsil-sub-text'>
        <h1>total budget</h1>
        <h4>$ 20,00,000</h4>
        <p> Khalawa village is located in Khalwa tehsil of Khandwa district in Madhya Pradesh, India. It is situated 52km away from sub-district headquarter Khalwa (tehsildar office) and 52km away from district headquarter Khandwa. As per 2009 stats, Khalwa P O is the gram panchayat of Khalawa village.

The total geographical area of village is 551.99 hectares. Khalawa has a total population of 7,612 peoples, out of which male population is 4,002 while female population is 3,610. Literacy rate of khalawa village is 70.18% out of which 76.19% males and 63.52% females are literate. There are about 1,585 houses in khalawa village.
