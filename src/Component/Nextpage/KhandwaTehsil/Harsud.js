...
<Link to="/sector"><span><AiOutlineArrowLeft /></span></Link>
    ...
    <div className='tehsil-sub-text'>
        <h1>total budget</h1>
        <h4>$ 20,00,000</h4>
        <p>Harsud was a town and municipality in Khandwa in the Indian state of Madhya Pradesh. Although the town was more than 700 years old, it was submerged under the waters of the Indira Sagar dam in July 2004.Harsud was located at 22.1°N 76.73°E[1] and had an average elevation of 243 metres (800 feet). The town was relocated to Chhanera (New Harsud)[2] after the old town was submerged.
        </p>
        </div>
    </div>
