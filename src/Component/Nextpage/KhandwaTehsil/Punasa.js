...
<Link to="/sector"><span><AiOutlineArrowLeft /></span></Link>
    ...
    <div className='tehsil-sub-text'>
        <h1>total budget</h1>
        <h4>$ 20,00,000</h4>
        <p>Punasa village is located in Punasa tehsil of Khandwa district in Madhya Pradesh, India. It is situated 55km away from district headquarter Punasa. Punasa is the sub-district headquarter of Punasa village. As per 2009 stats, Punasa village is also a gram panchayat.

The total geographical area of village is 788.01 hectares. Punasa has a total population of 7,225 peoples, out of which male population is 3,798 while female population is 3,427. Literacy rate of punasa village is 63.06% out of which 69.77% males and 55.62% females are literate. There are about 1,451 houses in punasa village.</p>
</div>
    </div>
