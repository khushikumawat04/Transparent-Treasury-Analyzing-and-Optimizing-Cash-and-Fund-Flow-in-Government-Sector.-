...
<div className="tehsil-title-container">
    ...
    <div className='tehsil-sub-text'>
        <h1>total budget</h1>
        <h4>$ 20,00,000</h4>
        <p>Anjad is a town and a nagar parishad in Barwani district in the state of Madhya Pradesh, India. GeographyAnjad is located in the Narmada Valley, at. It has an average elevation of 151 metres (495 feet). It is a tehsil in Barwani district.</p>
        </div>
    </div>
