...
const Thikri = () => {
  ...
  const getvillagedata = SectorData.find((state) => state.state_id === "1")
        ...
        .tehsil.find((tehsil) => tehsil.tehsil_id === "2").villages;
...
<div className="tehsil-title-container">
    ...
    <div className='tehsil-sub-text'>
        <h1>total budget</h1>
        <h4>$ 20,00,000</h4>
        <p>Thikri is a Town in Thikri Tehsil in Barwani District of Madhya Pradesh State, India. It belongs to Indore Division . It is located 59 KM towards East from District head quarters Barwani. It is a Tehsil head quarter.


Thikri Pin code is 451660 and postal head office is Thikari .

Umarda ( 3 KM ) , Segwal ( 4 KM ) , Ghatwa ( 6 KM ) , Abhali ( 7 KM ) , Chichali ( 8 KM ) are the nearby Villages to Thikri. Thikri is surrounded by Dharampuri Tehsil towards North , Kasrawad Tehsil towards East , Umarban Tehsil towards North , Ziranya Tehsil towards South .

Manawar , Barwani , Sendhwa , Dhar are the nearby Cities to Thikri.
</p>
</div>
    </div>
