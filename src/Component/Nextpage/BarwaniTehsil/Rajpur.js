...
<div className="tehsil-title-container">
    ...
    <div className='tehsil-sub-text'>
        <h1>total budget</h1>
        <h4>$ 20,00,000</h4>
        <p>Rajpur is located in the region of Madhya Pradesh. Madhya Pradesh's capital Bhopal (Bhopal) is approximately 312 km / 194 mi away from Rajpur (as the crow flies). The distance from Rajpur to India's capital New Delhi (New Delhi) is approximately 291 km / 181 mi (as the crow flies).</p>
        </div>
    </div>
