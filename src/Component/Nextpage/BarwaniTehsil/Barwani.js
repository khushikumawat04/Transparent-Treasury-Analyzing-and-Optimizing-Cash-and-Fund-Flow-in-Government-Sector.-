...
<div className="tehsil-title-container">
    ...
    <div className='tehsil-sub-text'>
        <h1>total budget</h1>
        <h4>$ 20,00,000</h4>
        <p>Barwani is a district in the Madhya Pradesh State of India. Total area of Barwani is 5,427 km² including 5,326.26 km² rural area and 100.74 km² urban area. As per 2011 stats, Barwani has a population of 13,85,881 peoples, out of which urban population is 2,04,069 while rural population is 11,81,812</p>
        </div>
    </div>
