...
<div className="tehsil-title-container">
    ...
    <div className='tehsil-sub-text'>
        <h1>total budget</h1>
        <h4>$ 20,00,000</h4>
        <p>Varla tehsil has a population of 1,28,721 peoples. Varla tehsil has a population density of 153.5 inhabitants per square kilometre. There are about 20,939 houses in the sub-district. When it comes to literacy, 26.61% population of varla tehsil is literate, out of which 30.93% males and 22.28% females are literate.</p>
        </div>
    </div>
