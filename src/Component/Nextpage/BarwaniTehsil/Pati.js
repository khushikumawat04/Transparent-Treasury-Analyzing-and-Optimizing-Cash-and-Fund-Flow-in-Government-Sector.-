...
<Link to="/sector"><span><AiOutlineArrowLeft /></span></Link>
    ...
    <div className='tehsil-sub-text'>
        <h1>total budget</h1>
        <h4>$ 20,00,000</h4>
        <p>Pati tehsil has an area of 669.80 sq kilometers. It is bounded by Alirajpur district in the northwest, Dhar district in the north, Barwani tehsil in the northeast, east and southeast, Pansemal tehsil in the south and southwest and Maharashtra in the west.</p>
        </div>
    </div>
