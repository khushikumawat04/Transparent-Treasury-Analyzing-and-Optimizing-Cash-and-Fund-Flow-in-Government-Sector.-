...
<div className="tehsil-title-container">
    ...
    <div className='tehsil-sub-text'>
        <h1>total budget</h1>
        <h4>$ 20,00,000</h4>
        <p>Pansemal tehsil has an area of 365.11 sq kilometers. It is bounded by Maharashtra in the northwest, west, southwest and south, Pati tehsil in the north, Barwani tehsil in the northeast and Niwali tehsil in the east and southeast. Pansemal and Khetia is a centre for industry.</p>
        </div>
    </div>
