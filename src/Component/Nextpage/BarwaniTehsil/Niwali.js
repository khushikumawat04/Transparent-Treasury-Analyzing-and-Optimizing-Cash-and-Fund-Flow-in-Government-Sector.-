...
<div className="tehsil-title-container">
    ...
    <div className='tehsil-sub-text'>
        <h1>total budget</h1>
        <h4>$ 20,00,000</h4>
        <p>Niwali is a Tehsil located in Barwani district of Madhya Pradesh. It is one of 9 Tehsils of Barwani district. There are 79 villages and 0 towns in Niwali Tehsil.
As per the Census India 2011, Niwali Tehsil has 18942 households, population of 112639 of which 56108 are males and 56531 are females. The population of children between age 0-6 is 23536 which is 20.9% of total population.</p>
</div>
    </div>
