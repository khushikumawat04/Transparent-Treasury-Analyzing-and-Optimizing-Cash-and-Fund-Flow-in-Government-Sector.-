...
<div className="tehsil-title-container">
    ...
    <div className='tehsil-sub-text'>
        <h1>total budget</h1>
        <h4>$ 20,00,000</h4>
        <p>Sendhwa Tehsil is an administrative subdivision (tehsil or tahsil) in Barwani District, Madhya Pradesh (state) of India. Its headquarters is in the town of Sendhwa. Sendhwa is the biggest revenue generating tehsil in the Barwani District. Sendhwa Tehsil has the highest population of any tehsil in Barwani district.</p>
        </div>
    </div>
