...
<div className="tehsil-title-container">
    ...
    <div className='tehsil-sub-text'>
        <h1>total budget</h1>
        <h4>$ 20,00,000</h4>
        <p>Dahi is a small town.Which have about 4 government schools and about 5 private schools.It have one girls played hostel.It have about 2 or 3 boys hostel facilities. And one famous place of this town is "Ghoda pati road". In this place 3 schools and one kanya hostel.
        </p>
        </div>
    </div>
