...
<div className="tehsil-title-container">
    ...
    <div className='tehsil-sub-text'>
        <h1>total budget</h1>
        <h4>$ 20,00,000</h4>
        <p>Badnawar (or Badnavar) is a Town, former pargana and a Nagar Parishad of the Dhar district in the state of Madhya Pradesh, India. This is a tehsil place having 170 villages. Badnawar is around 95 km from Indore - the business capital of Madhya Pradesh.
        </p>
        </div>
    </div>
