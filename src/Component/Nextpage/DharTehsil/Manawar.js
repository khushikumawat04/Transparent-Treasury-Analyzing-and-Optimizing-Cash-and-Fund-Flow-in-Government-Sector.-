...
<Link to="/sector"><span><AiOutlineArrowLeft /></span></Link>
    ...
    <div className='tehsil-sub-text'>
        <h1>total budget</h1>
        <h4>$ 20,00,000</h4>
        <p>Manawar is a town with tehsil in Dhar district in the Indian state of Madhya Pradesh. The name Manawar came from name of river Mān that flows at southern edge of the town. Pin code of Manawar is 454446.
        </p>
        </div>
    </div>
