...
<div className="tehsil-title-container">
    ...
    <div className='tehsil-sub-text'>
        <h1>total budget</h1>
        <h4>$ 20,00,000</h4>
        <p>According to Census 2011 information the location code or village code of Gandhwani village is 475293. Gandhwani village is located in Gandhwani tehsil of Dhar district in Madhya Pradesh, India. It is situated 70km away from district headquarter Gandhwani. Gandhwani is the sub-district headquarter of Gandhwani village. As per 2009 stats, Gandwani is the gram panchayat of Gandhwani village.
        </p>
        </div>
    </div>
