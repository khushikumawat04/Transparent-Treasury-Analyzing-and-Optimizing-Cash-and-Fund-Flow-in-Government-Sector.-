...
<div className="tehsil-title-container">
    ...
    <div className='tehsil-sub-text'>
        <h1>total budget</h1>
        <h4>$ 20,00,000</h4>
        <p>Dharampuri is a town and headquarters of a tehsil in Dhar district in the state of Madhya Pradesh, India. It is situated on banks of river Narmada. It is a place of some historical and archaeological interest.
        </p>
        </div>
    </div>
