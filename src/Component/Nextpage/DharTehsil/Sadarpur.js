...
<Link to="/sector"><span><AiOutlineArrowLeft /></span></Link>
    ...
    <div className='tehsil-sub-text'>
        <h1>total budget</h1>
        <h4>$ 20,00,000</h4>
        <p>Saroda is a small Village/hamlet in Sardarpur Tehsil in Dhar District of Madhya Pradesh State, India. It comes under Saroda Panchayath. It belongs to Indore Division . It is located 61 KM towards west from District head quarters Dhar. 22 KM from Sardarpur. 322 KM from State capital Bhopal.
        </p>
        </div>
    </div>
