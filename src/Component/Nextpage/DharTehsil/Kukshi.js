...
<Link to="/sector"><span><AiOutlineArrowLeft /></span></Link>
    ...
    <div className='tehsil-sub-text'>
        <h1>total budget</h1>
        <h4>$ 20,00,000</h4>
        <p>Kukshi is a town in Dhar district of Madhya Pradesh state, India. Kukshi has population of around 37,482 making it a Tier-3 city and a Semi-Urban centre. It is a Nagar Parishad. Kukshi is famous for the business of cotton, mirchi, gold and silver, and ready made garments.
        </p>
        </div>
    </div>
