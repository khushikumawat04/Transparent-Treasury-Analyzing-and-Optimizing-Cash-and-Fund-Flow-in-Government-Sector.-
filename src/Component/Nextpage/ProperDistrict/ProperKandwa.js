...
<Link to="/sector"><span><AiOutlineArrowLeft /></span></Link>
    ...
    <div className='tehsil-sub-text'>
        <h1>total budget</h1>
        <h4>$ 20,00,000</h4>
        <p>Khandwa is a city and a nagar nigam in the Nimar region of Madhya Pradesh, India. It is the administrative headquarters of the Khandwa district, formerly known as East Nimar District.
...
In May 2019, Nandkumar Singh Chauhan of Bharatiya Janata Party had been elected as the Member of Parliament from Khandwa Lok Sabha constituency.
        ...
        <div className="about-link">
              ...
              <Link to="https://khandwa.nic.in/en/village-panchayats/">https://khandwa.nic.in/en/village-panchayats/</Link>
            </div>
        </div>
    </div>
    ...
    <div className="cbox">
        ...
        <div className="small">
            ...
            <div className="sc-box">
              <h4>Population <br/>  <span>275,000</span></h4>
            </div>
            <div className="sc-box">
              <h4>Language <br/>  <span>Hindi,English<br/> Urdu, Marathi</span></h4>
            </div>
            <div className="sc-box">
              <h4>Villages <br/>  <span>537</span></h4>
            </div>
        </div>
