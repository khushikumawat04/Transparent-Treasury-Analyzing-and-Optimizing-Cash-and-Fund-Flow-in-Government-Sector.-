...
//   const getvillagedata = SectorData.find((state) => state.state_id === "1")
//         .District.find((district) => district.District_id === "2")
...
<div className="tehsil-title-container">
    ...
    <div className='tehsil-sub-text'>
        <h1>total budget</h1>
        <h4>$ 20,00,000</h4>
        <p>Barwani is situated on the south-west side of Madhya Pradesh as well as holy river Narmada is its northern border. District is surrounded by Satpuda (in South) and Vindhyachal (in North) forest ranges. District Barwani was formed on 25th May 1998. It was carved out of West-Nimar, Khargone district.

The name Barwani originated from the forests of Bad which had surrounded the city in old times, Wani is the old word for the Garden. Hence the city is known as Barwani, which means the Garden of  Bads.</p>
<div className="about-link">
              <strong>Visit For More Detail - </strong>
              <Link to="https://barwani.nic.in/">https://barwani.nic.in/</Link>
            </div>
</div>
    </div>
    ...
    <div className="cbox">
        ...
        <div className="small">
            <div className="sc-box">
              <h4>Area <br/>  <span>6477.89 Sq.Km.</span></h4>
            </div>
            <div className="sc-box">
              <h4>Population <br/>  <span>18,72,413</span></h4>
            </div>
            <div className="sc-box">
              <h4>Language <br/>  <span>Hiindi, Niimadi,<br/> Gujarati</span></h4>
            </div>
            <div className="sc-box">
              <h4>Villages <br/>  <span>1421</span></h4>
            </div>
        </div>
    ...
    >
      ...
      <input type="text" placeholder='Search Villages.....' value={searchTerm}/>
      </div>
    
    <div className="table-box">
    <div className="table-mini-box">
        <div className="box box-1">S.No</div>
        <div className="box box-2">WardNo</div>
    ...
    <div className="table-mini-box2">
        <div className="sbox box-mini-1">1</div>
    ...
    <div className="table-mini-box2">
        <div className="sbox box-mini-1">2</div>
        <div className="sbox box-mini-2"></div>
        <div className="sbox box-mini-3"></div>
        <div className="sbox box-mini-4">Sports</div>
    </div>
    ...
    <div className="table-mini-box2">
        <div className="sbox box-mini-1">3</div>
        <div className="sbox box-mini-2"></div>
        <div className="sbox box-mini-3"></div>
        <div className="sbox box-mini-4">Sports</div>
    </div>
    ...
    <div className="table-mini-box2">
        <div className="sbox box-mini-1">4</div>
        <div className="sbox box-mini-2"></div>
        <div className="sbox box-mini-3"></div>
        <div className="sbox box-mini-4">Sports</div>
    </div>
