...
<Link to="/sector"><span><AiOutlineArrowLeft /></span></Link>
    ...
    <div className='tehsil-sub-text'>
        <h1>total budget</h1>
        <h4>$ 20,00,000</h4>
        <p>Dhar is a city located in Dhar district of the Malwa region in the state of Madhya Pradesh, India. The city is the administrative headquarters of the Dhar district. Before Indian independence from Great Britain, it was the capital of the Dhar princely state.</p>
        <div className="about-link">
              <strong>Visit For More Detail - </strong>
              <Link to="https://dhar.nic.in/">https://dhar.nic.in/</Link>
            </div>
        </div>
    </div>
    ...
    <div className="cbox">
        ...
        <div className="small">
            <div className="sc-box">
              <h4>Area <br/>  <span>8153 Sq.Km.</span></h4>
            </div>
            <div className="sc-box">
              <h4>Population <br/>  <span>128,000</span></h4>
            </div>
            <div className="sc-box">
              <h4>Language <br/>  <span>Hindi<br/></span><br/></h4>
            </div>
            <div className="sc-box">
              <h4>Villages <br/>  <span>425</span></h4>
            </div>
        </div>
