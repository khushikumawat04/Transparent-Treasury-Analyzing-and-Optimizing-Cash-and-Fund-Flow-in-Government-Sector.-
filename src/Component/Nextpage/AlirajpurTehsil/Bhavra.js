...
<div className="tehsil-title-container">
    ...
    <div className='tehsil-sub-text'>
        <h1>total budget</h1>
        <h4>$ 20,00,000</h4>
        <p> Bhavra also known as Bhabhra or Chandra Shekhar Azad Nagar is a town and a nagar panchayat in Alirajpur district in the state of Madhya Pradesh, India. It is the birthplace of the noted revolutionary Chandra Shekhar Azad.</p>
        </div>
    </div>
