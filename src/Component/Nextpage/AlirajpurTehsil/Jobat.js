...
const Jobat = () => {
  ...
  const getvillagedata = SectorData.find((state) => state.state_id === "1")
        .District.find((district) => district.District_id === "5")
...
<div className="tehsil-title-container">
    ...
    <div className='tehsil-sub-text'>
        <h1>total budget</h1>
        <h4>$ 20,00,000</h4>
        <p> Jobat tehsil has a population of 1,91,404 peoples, out of which urban population is 11,976 while rural population is 1,79,428. Jobat tehsil has a population density of 269.3 inhabitants per square kilometre. There are about 31,756 houses in the sub-district, including 2,206 urban houses and 29,550 rural houses.</p>
        </div>
    </div>
