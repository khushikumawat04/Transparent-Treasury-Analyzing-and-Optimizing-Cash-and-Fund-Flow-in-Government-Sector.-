...
import AnimalHusbandry from './../AnimalHubandry/AnimalHusbandry'
import AnimalHusbandrydata from './AnimalHusbandrydata'
import '../scheme.css'
import {AiOutlineArrowLeft} from 'react-icons/ai'
import { Link } from 'react-router-dom'

const AnimalHusbandryScheme = () => {
  return (
    <>
...
export default AnimalHusbandryScheme;